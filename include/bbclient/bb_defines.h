...
#elif defined(BB_FORCE_PLATFORM_DPX) && BB_FORCE_PLATFORM_DPX
#undef BB_PLATFORM_DPX
#define BB_PLATFORM_DPX BB_ON
...
#if BB_USING(BB_PLATFORM_WINDOWS) || BB_USING(BB_PLATFORM_DURANGO)
#define BB_COMPILER_MSVC BB_ON
#define BB_COMPILER_CLANG BB_OFF
#else // #if BB_USING(BB_PLATFORM_WINDOWS) || BB_USING(BB_PLATFORM_DURANGO)
#define BB_COMPILER_MSVC BB_OFF
#define BB_COMPILER_CLANG BB_ON
#endif // #else // #if BB_USING(BB_PLATFORM_WINDOWS) || BB_USING(BB_PLATFORM_DURANGO)
